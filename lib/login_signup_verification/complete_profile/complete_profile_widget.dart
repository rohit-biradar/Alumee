...
class _CompleteProfileWidgetState extends State<CompleteProfileWidget> {
  ...
  void initState() {
    ...
    _model.phoneTextController3 ??= TextEditingController();
    _model.phoneFocusNode3 ??= FocusNode();
  }
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      TextFormField(
                        controller: _model.phoneTextController3,
                        focusNode: _model.phoneFocusNode3,
                        autofocus: false,
                        textCapitalization: TextCapitalization.words,
                        textInputAction: TextInputAction.next,
                        obscureText: false,
                        ...
                        keyboardType: TextInputType.name,
                        validator: _model.phoneTextController3Validator
                            .asValidator(context),
                        inputFormatters: [
                          if (!isAndroid && !isiOS)
                            TextInputFormatter.withFunction(
                              ...
                              onPressed: () async {
                                if ((_model.dropDownValue != null &&
                                    ...
                                    (_model.fullNameTextController.text !=
                                            '') &&
                                    (_model.phoneTextController2.text !=
                                            '') &&
                                    (_model.phoneTextController1.text !=
                                            '') &&
                                    (_model.phoneTextController3.text !=
                                            '')) {
                                  await UserTable().update(
                                    data: {
                                      'name':
                                          _model.fullNameTextController.text,
                                      'phone': _model.phoneTextController2.text,
                                  ...
                                  ScaffoldMessenger.of(context).showSnackBar(
                                    SnackBar(
                                      ...
                                      backgroundColor: Color(0xFFD82929),
                                    ),
                                  );
                                }
                              },
