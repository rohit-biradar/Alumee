...
import 'student_directory_model.dart';
export 'student_directory_model.dart';

class StudentDirectoryWidget extends StatefulWidget {
  const StudentDirectoryWidget({super.key});

  static String routeName = 'StudentDirectory';
  static String routePath = '/studentDirectory';

  @override
  State<StudentDirectoryWidget> createState() => _StudentDirectoryWidgetState();
}

class _StudentDirectoryWidgetState extends State<StudentDirectoryWidget> {
  late StudentDirectoryModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => StudentDirectoryModel());
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            ...
                                            Padding(
                                              ...
                                              child: Text(
                                                valueOrDefault<String>(
                                                  listViewUserRow.graduationYear
                                                      ?.toString(),
                                                  'Graduation year',
                                                ),
                                                style: FlutterFlowTheme.of(
