...
import 'adm_anal_model.dart';
export 'adm_anal_model.dart';
...
class AdmAnalWidget extends StatefulWidget {
  const AdmAnalWidget({super.key});

  static String routeName = 'AdmAnal';
  static String routePath = '/admAnal';

  @override
  State<AdmAnalWidget> createState() => _AdmAnalWidgetState();
}

class _AdmAnalWidgetState extends State<AdmAnalWidget> {
  late AdmAnalModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AdmAnalModel());
  }
